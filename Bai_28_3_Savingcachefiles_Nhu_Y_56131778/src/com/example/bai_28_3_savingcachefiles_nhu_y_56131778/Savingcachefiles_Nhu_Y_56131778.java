package com.example.bai_28_3_savingcachefiles_nhu_y_56131778;
...
public class Savingcachefiles_Nhu_Y_56131778 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_savingcachefiles__nhu__y_56131778);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.savingcachefiles__nhu__y_56131778, menu);
		return true;
	}
